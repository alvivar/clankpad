...
> Vendored upstream reference: relative links to Pi source files in this document point to the upstream Pi repository layout and are not valid inside the Clankpad repo.
